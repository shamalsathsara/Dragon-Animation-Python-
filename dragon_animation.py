# ============================================================
#   Dragon Animation  —  move your mouse, the dragon follows
#   Built with Python's built-in tkinter (no extra installs)
# ============================================================
...
COLOR_EYE_GLOW      = '#004858'   # halo behind the eye
COLOR_EYE_IRIS      = '#00e8ff'   # bright cyan iris
COLOR_EYE_IRIS_EDGE = '#a0ffff'
COLOR_EYE_PUPIL     = '#000c14'
COLOR_HALO_OUTER    = '#001228'   # big soft halo around the head
COLOR_HALO_MID      = '#001e38'
COLOR_GLOW_FAR      = '#000e1c'   # glow ribbons around the body
...
def build_ribbon(spine_points, half_widths):
    ...
    for i in range(total):
        # Direction vector along the spine at this point
        if i == 0:
            ...
            # Middle points — smooth direction using neighbours
...
def animate():
    ...
    # ── 2. Move the head toward the mouse (smooth follow) ──────────────────
    ...
    # ── 3. Pull body segments behind the head (inverse kinematics chain) ───
    ...
    # ── 4. Compute head angle & per-segment widths ──────────────────────────
    head_x, head_y = body_joints[0]
    ...
    # ── 5. Draw glow ribbons (three layers, each a little wider than the body) ─
    ...
    # ── 6. Draw the main body ribbon (dark base + belly + shine) ───────────
    ...
    # ── 7. Place scale dots along the body sides ────────────────────────────
    dot_index = 0
    ...
    for side_label, membrane, bones, veins in [
        ...
        # 4 finger-tips fan out from the root (like a bat wing)
